                ...
                <table className="min-w-full divide-y divide-gray-300">
                    <thead className="">
                        <tr>
                            ...
                            <th className={headerClasses}>Completed Words</th>
                            <th className={headerClasses}>Time (seconds)</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {stats.map((stat, index) => (
                            <tr key={index} className="">
                                ...
                                <td className={rowClass}>{stat.accuracy}%</td>
                                <td className={rowClass}>{stat.completed}</td>
